...
//bottom
bp = [[0,-27], [0,27], [35,32], [77,32], [77,-32], [35,-32]]; //bottom plate
yPoly(p=bp, px=-32);

//bottom side plates
fp=[[0,-27], [0,27], [12,27], [12,-27]]; //front plate
yPoly(p=fp, px=-31, ry=-70);

fsp=[[0,0], [35,0], [35,11], [4,11]];//front side plate
yPoly(p=fsp, px=-32, py=27, rx=90, rz=8);
yPoly(p=fsp, px=-32, py=-26, rx=90, rz=-8);

bsp=[[0,0], [42,0], [42,11], [0,11]];//back side plate
yPoly(p=bsp, px=3,py=32,rx=90);
yPoly(p=bsp, px=3,py=-31,rx=90);

//top side plates
ftsp=[[0,0], [31,0], [32,15], [0,2]];//Front top side plate
yPoly(p=ftsp, px=-28, py=28, pz=11, rx=138, rz=8);
yPoly(p=ftsp, px=-28, py=-27, pz=11, rx=42, rz=-8);

btsp=[[0,0], [42,0], [45,10.5],[37,14], [2.2,14]];//Back top side plate
yPoly(p=btsp, px=3, pz=11, py=32,rx=130);
yPoly(p=btsp, px=3, pz=11, py=-31,rx=50);

//back round section
ySec(r=70, a=[63,117],px=-18, rz=-90);
yArc(r=70, a=[63,117],px=-18, rz=-90, szz=13);

//roof
frp=[[0,27], [34.5,21], [34.5,-21], [0,-27]];//Front Roof Plate
yPoly(p=frp, px=-28, pz=12, ry=-15.5);
crp=[[0,21], [34,21], [34,-21], [0,-21]];//Center Roof Plate
yPoly(p=crp,px=5, pz=21);
//back roof plate
difference(){
    ySec(r=70, a=[69.5,110.5], px=-15, pz=36, rx=-15.5, rz=-90);
